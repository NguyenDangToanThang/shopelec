          ...
          return AlertDialog(
            ...
            content: DropdownButtonFormField (
              ...
              onChanged: (String? newValue) {
                setState(() {
                  dropdowns = newValue!;
                  _textFieldController.value = TextEditingValue(text: dropdowns);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () async {
                        String? result = await _showTextInputDialog(context,"Adjust name", name, email);
                        _textFieldController.value = TextEditingValue(text: result ?? "");
                        if(result != null) {
                          Map data_update = {
                            'id' : id,
                            'email' : email,
                          ...
                          authViewModel.updateUser(data_update, context).whenComplete(() {
                            setState(() {
                              name = result!;
                            });
                            Utils.flushBarSuccessMessage("Update completed", context);
                          }).onError((error, stackTrace) => Utils.flushBarErrorMessage(error.toString(), context));
                        }
                      },
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () async {
                        ...
                        String? result = await _showTextInputDialog(context,"Adjust Phone Number", phoneNumber, email);
                        if(result != null) {
                          Map data_update = {
                            'id' : id,
                            'email' : email,
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () async {
                          ...
                          String? result = await _showTextInputDialogDropDown(context, "Select your gender", gender);
                          if(result != null) {
                            Map data_update = {
                              'id' : id,
                              'email' : email,
